...
def parse_args():
    ...
    parser.add_argument(
        '--dataset', dest='dataset', default='coco2017',                                               #the neme of file，data/coco2017/
        help='Dataset to use')
    parser.add_argument(
        '--cfg', dest='cfg_file', default='../configs/baselines/e2e_faster_rcnn_R-50-FPN_1x.yaml',     #choice the baseline
    ...
    parser.add_argument(
        ...
        default=100, type=int)                                                                #display the info
    parser.add_argument(
    ...
    parser.add_argument(
        '--bs', dest='batch_size',
        help='Explicitly specify to overwrite the value comed from cfg_file.', default= 8,
        type=int)
    parser.add_argument(
        '--nw', dest='num_workers',
    ...
    parser.add_argument(                                                            #load the pretrained weight
...
def main():
    ...
    if not torch.cuda.is_available():                        #use gpu
        sys.exit("Need a CUDA device to run the code.")

    if args.cuda or cfg.NUM_GPUS > 0:                        #mutlpy gpu
        cfg.CUDA = True
    else:
        raise ValueError("Need Cuda device to run !")

    if args.dataset == "coco2017":                           #the name of train dataset
        cfg.TRAIN.DATASETS = ('coco_2017_train',)
        cfg.MODEL.NUM_CLASSES = 21                           #class of train dataset，change！！！！！！！！！！！！
    ...
    cfg_from_file(args.cfg_file)                             #the name of cfg file
    ...
    # CHECKPOINT_PERIOD = int(cfg.TRAIN.SNAPSHOT_ITERS / cfg.NUM_GPUS)      #20000

    CHECKPOINT_PERIOD = 10001

...
from make_submision import make_submission
import shutil
...
def parse_args():
    ...
    parser.add_argument(
        '--cfg', dest='cfg_file', default= '../configs/baselines/e2e_faster_rcnn_R-50-FPN_1x.yaml',
    ...
    parser.add_argument('--load_ckpt', help='path of checkpoint to load', default='../trained_weight/best_model.pth')       #the trained weight
    parser.add_argument(
        '--load_detectron', help='path to the detectron weight pickle file')

    parser.add_argument(
        '--image_dir',
        help='directory to load images for demo', default="../test/")          #the file of test pictues
    parser.add_argument(
        '--images', nargs='+',
    ...
    parser.add_argument(
        ...
        default=" ")                                             #the file to save result pic
    parser.add_argument(
...
if __name__ == '__main__':
    main()
    print("JUST WAIT A MINUTE, MAKING RESULTS.....")
    make_submission()
    print("Success!")
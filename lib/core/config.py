...
__C.TRAIN.SCALES = (400, )                                         #缩放尺寸,改

# Max pixel size of the longest side of a scaled input image
__C.TRAIN.MAX_SIZE = 600                                          #长边最大的数值，原来是1000
...
__C.TRAIN.BBOX_THRESH = 0.50                                          #这个修改！！！！！！！！！！！！！！！！！！！！！！！！原来是0.5
...
# Max pixel size of the longest side of a scaled input image
__C.TEST.MAX_SIZE = 800                                                         #测试时长边最大的数值，原来是1200
...
__C.FPN.RPN_ASPECT_RATIOS = (0.5, 1, 2)                                       #更改anchor的缩放比例，原来是 0.5, 1, 2
...
__C.FPN.RPN_ANCHOR_START_SIZE = 32                                              #更改，原来是32
